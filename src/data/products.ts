...
export const partyProducts: ProductCardProps[] = [
  {
    ...
    buttonText: '詳しくはこちら',
    buttonHref: 'https://www.tea-and-coffee.shop/view/item/000000000307',
  },
  {
    title: '抹茶スイーツお試しセット',
    price: '2,268',
    ...
    buttonText: '詳しくはこちら',
    buttonHref: 'https://www.tea-and-coffee.shop/view/item/000000000184',
  },
  {
    title:
    ...
    buttonText: '詳しくはこちら',
    buttonHref: 'https://www.tea-and-coffee.shop/view/item/000000000678',
  },
  {
    title:
      'KFK (カフカ) <ドリップコーヒー> ロマンスコーヒーセレクションギフトセット [ガラパゴス/エチオピア 各10g×5P入り]',
    price: '2,268',
    description:
      '焙煎、鮮度、品質にこだわった人の心を魅了するワンランク上のコーヒーのギフトセットです。',
    buttonText: '詳しくはこちら',
    buttonHref: 'https://www.tea-and-coffee.shop/view/item/000000000770',
  },
];
